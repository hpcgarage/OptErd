...
C  in the file COPYING.
         SUBROUTINE  OED__CTR_PAIR_UPDATE
     +
     +                    ( N,
     +                      NPMAX,NPMIN,
     +                      MIJ,NRS,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : OED__CTR_PAIR_UPDATE
...
C                form over invariant indices n and updates old
C                transformed integrals:
C
C                   y (n,rs) = y (n,rs)
C                              + sum  ccr (r,i) * ccs (s,j) * x (n,ij)
C                                 ij
C
...
C                  Output:
C
C                    Y            =  contains the updated transformed
C                                    integrals
C
C
