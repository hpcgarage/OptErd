...
C  in the file COPYING.
         SUBROUTINE  OED__MEMORY_KIN_BATCH
     +
     +                    ( NALPHA,NCOEFF,
     +                      NCGTO1,NCGTO2,
     +                      NPGTO1,NPGTO2,
