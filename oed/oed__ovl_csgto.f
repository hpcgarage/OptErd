...
C
     ...
     +
     +
C            WRITE (*,*) ' Finished e0 overlap pcgto block '
...
C
C
C             ...the unnormalized cartesian (e|0) contracted overlap
