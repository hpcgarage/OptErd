...
C  in the file COPYING.
         SUBROUTINE  OED__XYZ_1D_MOM_AB_INTEGRALS
     +
     +                    ( SHELLP,SHELLX,
     +                      SHELLA,SHELLB,
     +                      NEXP,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : OED__XYZ_1D_AB_INTEGRALS
...
C            INT1D (N,0,1) = PA (N)
            ...
            INT1D (N,0,1) = PA (N) * INT1D  (N,0,0)        ! Watson Changed
     +                             + PINVHF (N)
         END DO
...
C            INT1D (N,1,0) = PA (N)
            INT1D (N,0,0) = IP (N)                         ! Watson Changed
            INT1D (N,1,0) = PA (N) * INT1D  (N,0,0)        ! Watson Changed
     +                             + PINVHF (N)
         END DO
...
C            INTSCR (N,1,0) = PA (N)
            ...
            INTSCR (N,1,0) = PA (N) * INTSCR (N,0,0)       ! Watson Changed
     +                              + PINVHF (N)
         END DO
